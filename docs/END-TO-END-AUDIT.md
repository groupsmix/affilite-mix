...
[Supabase Postgres + RLS]
    ...
    |-- 93 forward migrations + down migrations
    |
...
11. **Migration discipline:** 93 forward migrations with corresponding down migrations. CI-enforced migration policy check. Migration safety documentation.
...
- 93 migrations with down-migration support shows disciplined schema evolution.
