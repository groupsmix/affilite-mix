...
| A54-04 | Info     | \_\_Host- prefix | `lib/auth.ts:20`, `lib/cookie-utils.ts:50-60` | Production cookies use `__Host-` prefix (requires Secure, Path=/, no Domain). Prevents subdomain injection.     | None — compliant. | Cookie Prefix spec    |
