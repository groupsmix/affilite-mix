...
| `STRIPE_SECRET_KEY` | Stripe API access | TBD | TBD | Restricted API key (rk_live_) |
| `STRIPE_WEBHOOK_SECRET` | Stripe webhook signature verification | TBD | TBD | whsec_ token |
