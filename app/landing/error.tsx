...
export default function LandingError({
  ...
  useEffect(() => {
    reportError(error, { boundary: "landing", digest: error.digest });
  }, [error]);

  return (
    <div className="flex min-h-screen items-center justify-center bg-[#0a0b0f] px-4">
      <div className="text-center">
        <div className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-red-900/30 mx-auto">
          <svg
