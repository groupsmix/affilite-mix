export default function AdminDashboardLoading() {
  return (
    <div className="mx-auto max-w-5xl animate-pulse">
      ...
      <div className="mb-6 h-4 w-48 rounded bg-gray-100 dark:bg-gray-800" />
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap gap-2">
          {Array.from({ length: 4 }).map((_, i) => (
            <div
              key={i}
              className="h-9 w-32 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900"
            />
          ))}
        </div>
      </div>
