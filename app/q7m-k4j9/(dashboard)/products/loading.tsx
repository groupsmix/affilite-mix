export default function AdminProductsLoading() {
  return (
    <div className="mx-auto max-w-5xl animate-pulse">
      ...
      {/* CSV tools skeleton */}
      <div className="mb-6 h-10 w-full rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900" />
        ...
        {Array.from({ length: 4 }).map((_, i) => (
          ...
          >
            ...
            <div className="mb-3 flex flex-wrap items-center gap-2">
              ...
              <div className="h-5 w-12 rounded bg-amber-100 dark:bg-amber-900/30" />
            </div>
