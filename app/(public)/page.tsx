...
const WatchHomepage = dynamic(() => import("./components/watch-homepage").then((m) => m.WatchHomepage));
const CinematicHomepage = dynamic(() => import("./components/homepage-cinematic").then((m) => m.CinematicHomepage));
const MinimalHomepage = dynamic(() => import("./components/homepage-minimal").then((m) => m.MinimalHomepage));
