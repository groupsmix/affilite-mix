...
import { etsyTools, getEtsyReviewByToolSlug, type EtsyTool } from "@/lib/etsy-product-data";
...
export function EtsyHomepage({ site, recentContent }: EtsyHomepageProps) {
  ...
  const featuredShot = featuredTool ? TOOL_SHOTS[featuredTool.slug] : undefined;
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-16 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
          <div>
            ...
            <p className="mt-5 max-w-lg text-[17px] leading-relaxed" style={{ color: "#94A3B8" }}>
              We don&apos;t rely on affiliate rankings. Our scorecards are generated by a systematic
              audit of API response times, data fidelity against real shop metrics, and policy
              compliance.
            </p>
