    ...
    <div className="my-6 grid gap-4 sm:grid-cols-2">
      ...
      <div className="rounded-lg border border-emerald-200 bg-emerald-50 p-4">
        ...
        {pros.length > 0 ? (
          ...
          <p className="text-sm italic text-emerald-600">{isAr ? "لا توجد مميزات مدرجة" : "No pros listed"}</p>
        )}
      </div>
      ...
      <div className="rounded-lg border border-red-200 bg-red-50 p-4">
        ...
        {cons.length > 0 ? (
          ...
          <p className="text-sm italic text-red-600">{isAr ? "لا توجد عيوب مدرجة" : "No cons listed"}</p>
        )}
      </div>
    </div>
  );
