...
import { stripAiDisclosure } from "@/lib/human-content";
import {
...
Do NOT mention AI, machine generation, ChatGPT, or that the content was generated by an AI.
The byline is always a human editor or the site editorial team.
...
function parseResponse(
  ...
  return {
    title: stripAiDisclosure(title),
    slug,
    excerpt: stripAiDisclosure(excerpt || title),
    body: stripAiDisclosure(body || raw),
    metaTitle: stripAiDisclosure(metaTitle || title.slice(0, 60)),
    metaDescription: stripAiDisclosure(metaDescription || excerpt.slice(0, 155)),
    contentType,
  };
}
