...
export const API_ROUTE_METADATA: ReadonlyArray<RouteMetadata> = [
  ...
  },
  {
    ...
    methods: ["GET"],
    requestSchema: null,
    responseSchema: "SearchConsoleAnalytics",
    sensitiveFields: [],
    notes: "Google Search Console search-analytics per page (super_admin only).",
  },
  {
    ...ADMIN_DEFAULTS,
    auth: "super_admin",
    path: "/api/admin/seo/decay",
    methods: ["GET"],
    requestSchema: null,
    responseSchema: "DecayCandidates",
    sensitiveFields: [],
    notes: "Stale published content that should be refreshed (super_admin only).",
  },
  {
    ...ADMIN_DEFAULTS,
    auth: "super_admin",
  ...
  {
    ...ADMIN_DEFAULTS,
    path: "/api/admin/automation/actions",
    methods: ["GET"],
    requestSchema: null,
    responseSchema: "AutomationAction[]",
    sensitiveFields: ["authorization"],
    notes: "Lists site-scoped automation actions for owner review.",
  },
  {
    ...ADMIN_DEFAULTS,
    path: "/api/admin/automation/actions/[id]/approve",
    methods: ["POST"],
    requestSchema: null,
    responseSchema: "AutomationAction",
    sensitiveFields: [],
    notes: "Human-owner-only approval and immediate execution endpoint.",
  },
  {
    ...ADMIN_DEFAULTS,
    path: "/api/admin/automation/actions/[id]/reject",
    methods: ["POST"],
    requestSchema: "AutomationActionRejectInput",
    responseSchema: "AutomationAction",
    sensitiveFields: [],
    notes: "Human-owner-only rejection endpoint.",
  },
  {
    ...ADMIN_DEFAULTS,
    path: "/api/admin/automation/actions/[id]/rollback",
    methods: ["POST"],
    requestSchema: null,
    responseSchema: "AutomationAction",
    sensitiveFields: [],
    notes: "Human-owner-only snapshot rollback endpoint.",
  },
  {
    path: "/api/automation/v1/products/[id]",
    methods: ["PATCH"],
    auth: "automation",
    adminRequired: false,
    scope: "site",
    rateLimit: false,
    csrf: false,
    requestSchema: "AutomationProductUpdateInput",
    responseSchema: "AutomationEnvelope",
    sensitiveFields: ["authorization", "idempotency-key"],
    notes: "Requires scope products:update. Updates safe, site-scoped product metadata.",
  },
  {
    path: "/api/automation/v1/products/[id]/activate",
    methods: ["POST"],
    auth: "automation",
    adminRequired: false,
    scope: "site",
    ...
    responseSchema: "AutomationEnvelope",
    sensitiveFields: ["authorization", "idempotency-key"],
    notes: "Requires scope products:activate. Approval-gated lifecycle activation.",
  },
  {
    path: "/api/automation/v1/products/[id]/affiliate-url",
    methods: ["POST"],
    auth: "automation",
    adminRequired: false,
    scope: "site",
